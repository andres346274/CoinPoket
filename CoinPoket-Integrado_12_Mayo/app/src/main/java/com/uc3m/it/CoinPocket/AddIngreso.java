...
public class AddIngreso extends AppCompatActivity {
    ...
    private void registrarGasto(){
        ...
        /*
        Se realiza la conversión de la moneda, se divide la cantidad que se ha introducido
        entre el valor del ratio, es decir, entre la cantidad a la que equivale un euro en la
        moneda elegida. Así se guarda todo en euros en la base de datos.
         */
        try {
